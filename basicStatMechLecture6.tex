...
\imageFigure{../figures/phy452-basicstatmech/basicStatMechLecture6Fig1}{Phase space volume trajectory.}{fig:basicStatMechLecture6:basicStatMechLecture6Fig1}{0.2}
...
\end{enumerate}
\begin{equation}\label{eqn:basicStatMechLecture6:180}
\begin{aligned}
\Omega&(N, V, E) = \int_V
d\Bx_1
d\Bx_2
...
\imageFigure{../figures/phy452-basicstatmech/basicStatMechLecture6Fig2}{Heavyside theta, \(\Theta(x)\).}{fig:basicStatMechLecture6:basicStatMechLecture6Fig2}{0.2}
we have
...
%
This gives
\begin{equation}\label{eqn:basicStatMechLecture6:300}
\begin{aligned}
\gamma(N, V, E)
...
\imageFigure{../figures/phy452-basicstatmech/basicStatMechLecture6Fig3}{Uncertainty principle phase space volume adjustment.}{fig:basicStatMechLecture6:basicStatMechLecture6Fig3}{0.2}
%
