...
\begin{equation}\label{eqn:velocityToMomentumChangeOfVariables:200}
\epsilon = \sqrt{ (p c)^2 + \epsilon_0^2 },
\end{equation}
where the rest energy is
\begin{equation}\label{eqn:velocityToMomentumChangeOfVariables:220}
\epsilon_0 = m c^2.
\end{equation}
%
Hamilton's equations give us
\begin{equation}\label{eqn:velocityToMomentumChangeOfVariables:240}
u_\alpha = \frac{ p_\alpha/c^2 }{\epsilon},
\end{equation}
or
\begin{equation}\label{eqn:velocityToMomentumChangeOfVariables:260}
...
\begin{equation}\label{eqn:huang93:160}
\begin{aligned}
...
\begin{equation}\label{eqn:huang93:180}
