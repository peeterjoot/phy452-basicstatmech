...
Our Hamiltonian is
\begin{equation}\label{eqn:3nParticlePhaseSpaceVolume:20}
\begin{aligned}
H
...
\begin{equation}\label{eqn:3nParticlePhaseSpaceVolume:40}
\begin{aligned}
\int_{ E - \frac{\Delta}{2} \le H \le E + \frac{\Delta}{2} \le H } d^{3N} x d^{3N} p
&=
\int_{ E - \frac{\Delta}{2} \le
\sum_{i_\alpha}
...
This gives us
\begin{equation}\label{eqn:3nParticlePhaseSpaceVolume:60}
\begin{aligned}
&\int_{
...
\begin{equation}\label{eqn:3nParticlePhaseSpaceVolume:80}
\int_{
E - \frac{\Delta}{2} \le H \le E + \frac{\Delta}{2} \le H
}
 d^{3N} x d^{3N} p
