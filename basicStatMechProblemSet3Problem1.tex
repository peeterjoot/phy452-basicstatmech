...
%
\makeoproblem{Surface area of a d-sphere}{basicStatMech:problemSet3:1}{2013 ps3, p1}{
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:20}
V_2(R) = 4 \int_0^R r dr \int_0^{\pi/2} d\theta = 4 \frac{R^2}{2} \frac{\pi}{2} = \pi R^2
\end{equation}
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:40}
\begin{aligned}
V_3(R) 
&= 8 \int_0^R r^2 dr \int_0^{\pi/2} \sin\theta d\theta \int_0^{\pi/2} d\phi \\
...
%
\imageFigure{../figures/phy452-basicstatmech/basicStatMechProblemSet3Fig1}{Integrating over just one quadrant of circle or octet of sphere.}{fig:basicStatMechProblemSet3:basicStatMechProblemSet3Fig1}{0.2}
%
...
\end{equation}
%
After factoring out common terms, that Jacobian reduces to
%\( J_5 \) is
%\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:180}
%\begin{aligned}
%\left\lvert
%\begin{array}{lllll}
...
&J5
=
r^4 S_4^3 S_3^2 S_2^1 S_1^0 \times \\
%\begin{vmatrix}
%C_4               & -S_4               &   0            &  0       &  0   \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:200}
\begin{aligned}
J_5
...
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:220}
\begin{aligned}
J_4
...
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:240}
\begin{aligned}
J_3
&= r^2 S_2^1 S_1^0
\left\lvert
...
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:260}
\begin{aligned}
J_2
&= r S_1^0
\left\lvert
...
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:300}
\begin{aligned}
V_n(R)
&= 2^n
\int_0^R r^{n-1} dr
...
\end{array}
\end{equation}
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:380}
\begin{aligned}
V_{2(n)}
...
\end{array}
\end{equation}
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:440}
\begin{aligned}
V_{2(n)+1}
...
%
This gives us
\begin{equation}\label{eqn:basicStatMechProblemSet3Problem1:520}
\begin{aligned}
V_{2(n)+1}
