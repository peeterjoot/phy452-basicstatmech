...
\imageFigure{../figures/phy452-basicstatmech/lecture14Fig1}{Ensemble pictures.}{fig:lecture14:lecture14Fig1}{0.2}
%\cref{fig:lecture14:lecture14Fig2}.
%\imageFigure{../figures/phy452-basicstatmech/lecture14Fig2}{CAPTION}{fig:lecture14:lecture14Fig2}{0.2}
%F1
%F2
%
...
\begin{equation}\label{eqn:basicStatMechLecture14:20}
...
\begin{equation}\label{eqn:basicStatMechLecture14:40}
\begin{aligned}
\Omega_R
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture14:60}
\frac{\mu}{T} = -\PDc{N}{S_R}{V,E}
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture14:80}
\frac{1}{T} = \PDc{E}{S_R}{N,V}.
\end{equation}
\end{subequations}
% FIXME: these labeled as reservoir property.
\begin{equation}\label{eqn:basicStatMechLecture14:100}
\calP \propto
e^{\frac{\mu}{\kB T} N_S}
e^{-\frac{E_S}{\kB T} }.
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture14:120}
\ZG = \sum_{\{c\}}
e^{\frac{\mu}{\kB T} N_S}
e^{-\frac{E_S}{\kB T} }.
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture14:140}
\calP(E_S, N_S) =
\frac{
e^{\frac{\mu}{\kB T} N_S}
e^{-\frac{E_S}{\kB T} }
...
\begin{equation}\label{eqn:basicStatMechLecture14:160}
\{ c \} \rightarrow \{ x \} \{ p \},
\end{equation}
whereas in a quantum content we have
\begin{equation}\label{eqn:basicStatMechLecture14:180}
\{ c \} \rightarrow \text{eigenstate}.
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture14:200}
...
\begin{equation}\label{eqn:basicStatMechLecture14:220}
\int_{
\{ x \} \{ p \}
}
 \delta\lr{
...
\begin{equation}\label{eqn:basicStatMechLecture14:260}
Z_c = \int_{
\{ x \} \{ p \}
}
e^{-\beta \lr{
...
\imageFigure{../figures/phy452-basicstatmech/lecture14Fig3}{A subsystem to and from which particle motion is allowed.}{fig:lecture14:lecture14Fig3}{0.2}
%
...
\imageFigure{../figures/phy452-basicstatmech/lecture14Fig4}{Energy level filling in a quantum system.}{fig:lecture14:lecture14Fig4}{0.2}
%
For every momentum \(k\) there are two possible occupation numbers \(n_k \in \{0, 1\}\)
our partition function is
\begin{equation}\label{eqn:basicStatMechLecture14:240}
Z_c = \sum_{
n_k,
\sum_k n_k = N
...
\end{equation}
%
We would find that this calculation with this \(\sum_k n_k = N\) constraint becomes essentially impossible, and
will see that relaxing this constraint will allow this calculation to become tractable.
%\EndArticle
