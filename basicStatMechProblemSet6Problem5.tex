...
\begin{equation}\label{eqn:huang93:100}
...
\begin{equation}\label{eqn:huang93:40}
\begin{aligned}
n
&= \frac{N}{V} \\
&=
...
\begin{equation}\label{eqn:huang93:60}
...
\begin{equation}\label{eqn:huang93:620}
n_0 = \frac{8 \pi}{3}
\lr{ \frac{\epsilon_0}{c h} }^3,
\end{equation}
so that the Fermi energy is
\begin{equation}\label{eqn:huang93:700}
\frac{\epsilon_{\txtF}}{\epsilon_0}
=
\sqrt{
\lr{\frac{n}{n_0}}
...
\begin{equation}\label{eqn:huang93:120}
...
\begin{equation}\label{eqn:huang93:140}
u_x
%=
%\xdot
= \PD{p_x}{\epsilon}
...
\begin{equation}\label{eqn:huang93:220}
...
\begin{equation}\label{eqn:huang93:340}
P
=
...
\begin{equation}\label{eqn:huang93:360}
f(c \Bp)
\propto \frac{
...
\begin{equation}\label{eqn:huang93:380}
\begin{aligned}
d^3 (c \Bp)
...
\begin{equation}\label{eqn:huang93:240}
c^2 p^2 = \epsilon^2 - \epsilon_0^2
,
\end{equation}
gives us
%\begin{equation}\label{eqn:huang93:260}
...
\begin{equation}\label{eqn:huang93:400}
\begin{aligned}
d^3 (c \Bp)
&=
...
\begin{equation}\label{eqn:huang93:420}
f(c \Bp) d^3 (c \Bp)
= C
\frac
{
...
\begin{equation}\label{eqn:huang93:600}
C^{-1} =
\int_{0}^\infty
...
\begin{equation}\label{eqn:huang93:480}
\begin{aligned}
P
...
\begin{equation}\label{eqn:huang93:500}
P
...
\begin{equation}\label{eqn:huang93:560}
\begin{aligned}
n
&=
\left(2
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem5:660}
\begin{aligned}
\inv{n_0}
&=
3 \frac
...
\end{equation}
or
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem5:680}
P V
=
\frac{U}{3}
\frac
...
\begin{equation}\label{eqn:huang93:800}
\begin{aligned}
...
\begin{equation}\label{eqn:huang93:1220}
\begin{aligned}
\lr{ (\theta x + 1)^2 -1 }
^{3/2}
&=
...
\begin{equation}\label{eqn:huang93:1240}
\begin{aligned}
...
\begin{equation}\label{eqn:huang93:1260}
\begin{aligned}
...
\begin{equation}\label{eqn:huang93:80}
\begin{aligned}
...
%
\imageFigure{../figures/phy452-basicstatmech/huang93Fig5sv}{Pressure to ten terms in \(\barz\) and \(\theta\).}{fig:huang93:huang93Fig5}{0.2}
%
...
\begin{equation}\label{eqn:huang93:880}
\begin{aligned}
\frac{n}{n_0}
&=
\theta
...
\begin{equation}\label{eqn:huang93:1080}
\begin{aligned}
&\frac{\expectation{\epsilon - \epsilon_0}}{V \epsilon_0 n_0} \\
&=
3 \theta^2
...
\begin{equation}\label{eqn:huang93:1100}
...
\begin{equation}\label{eqn:huang93:1120}
U\left(-\frac{3}{2},-4,\frac{2 (s+1)}{\theta }\right)
=
...
\begin{equation}\label{eqn:huang93:1140}
\begin{aligned}
&\frac{\expectation{\epsilon - \epsilon_0}}{V \epsilon_0 n_0}
=
...
\begin{equation}\label{eqn:huang93:1160}
\frac{\expectation{\epsilon - \epsilon_0}}{V \epsilon_0 n_0}
=
