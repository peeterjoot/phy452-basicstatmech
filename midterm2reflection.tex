...
%
\makeoproblem{Magnetic spin level splitting}{pr:midterm2reflection:1}{2013 midterm II p1}{
%(5 points)
...
\begin{equation}\label{eqn:midterm2reflection:20}
\begin{aligned}
Z
&= \sum_{m = -S}^S e^{-\Hbar \beta m B} \\
&= e^{-\Hbar \beta S B} \sum_{m = -S}^S e^{-\Hbar \beta (m + S) B} \\
&= e^{\Hbar \beta S B} \sum_{n = 0}^{2 S} e^{-\Hbar \beta n B}.
\end{aligned}
\end{equation}
%
Writing
...
\end{equation}
that is
\begin{equation}\label{eqn:midterm2reflection:560}
\begin{aligned}
Z 
&= a^{-S} \sum_{n = 0}^{2 S} a^n \\
...
\end{equation}
%
These are, up to a sign, identical, at least in this case, since we have \(\beta\) and \(B\) travelling together in the partition function.
%
In terms of the average energy
\begin{equation}\label{eqn:midterm2reflection:580}
\begin{aligned}
M
&= -\frac{\expectation{H}}{B} \\
...
\begin{equation}\label{eqn:midterm2reflection:180}
\begin{aligned}
\mu
&= \PD{B}{F} \\
...
\begin{equation}\label{eqn:midterm2reflection:600}
\begin{aligned}
\PD{(\beta B)}{} \ln Z
&=
\PD{(\beta B)}{} \ln
...
%
This gives us
\begin{equation}\label{eqn:midterm2reflection:620}
\begin{aligned}
\mu
&=
-\inv{Z}
...
\begin{equation}\label{eqn:midterm2reflection:260}
\begin{aligned}
Z
&=
...
With
\begin{subequations}
\begin{equation}\label{eqn:midterm2reflection:280}
u = \sqrt{\frac{\beta}{2m}} p_x
\end{equation}
\begin{equation}\label{eqn:midterm2reflection:300}
v = \sqrt{\frac{\beta}{2m}} p_y,
\end{equation}
\end{subequations}
the momentum integrals are
\begin{equation}\label{eqn:midterm2reflection:320}
\begin{aligned}
\int dp_x dp_y e^{-\beta p_x^2/2 m} e^{-\beta p_y^2/2 m}
&=
\frac{2m}{\beta}
...
Writing
\begin{subequations}
\begin{equation}\label{eqn:midterm2reflection:340}
f(x) = \inv{2} m \omega^2 x^2 + a x^4
\end{equation}
\begin{equation}\label{eqn:midterm2reflection:360}
...
The mean energy is
\begin{equation}\label{eqn:midterm2reflection:400}
\begin{aligned}
\expectation{H}
...
\begin{equation}\label{eqn:midterm2reflection:420}
\begin{aligned}
\CV
&= \PD{T}{\expectation{H}} \\
&= \PD{T}{\beta} \PD{\beta}{\expectation{H}} \\
&= -\inv{\kB T^2} \PD{\beta}{\expectation{H}} \\
&= -\kB \beta^2 \PD{\beta}{\expectation{H}} \\
&=
- \kB \beta^2
\lr{
-\inv{\beta^2}
...
\begin{equation}\label{eqn:midterm2reflection:440}
\PD{\beta}{}
\frac{
\int dx f(x) e^{- \beta f(x)}
}
...
\begin{equation}\label{eqn:midterm2reflection:381}
\begin{aligned}
Z 
&\approx
\frac{2 \pi m}{\beta}
...
\begin{equation}\label{eqn:midterm2reflection:500}
\begin{aligned}
\expectation{H}
&=
- \PD{\beta}{}
