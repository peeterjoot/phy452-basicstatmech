...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:20}
\begin{aligned}
\rho
&= \frac{N}{V} \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:40}
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:60}
\epsilon_{\txtF} = \frac{\Hbar^2}{2 m}
\lr{ \frac{3 \pi^2 \rho}{2}}
^{2/3}.
\end{equation}
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:80}
\begin{aligned}
...
%
This gives us
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:100}
\begin{aligned}
\epsilon_{\txtF}
...
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:120}
E = \frac{3}{5} N \epsilon_{\txtF},
\end{equation}
so the average energy per nucleon is approximately
\begin{equation}\label{eqn:basicStatMechProblemSet6Problem3:140}
