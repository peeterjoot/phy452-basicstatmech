...
\end{equation}
and
\begin{equation}\label{eqn:basicStatMechLecture2:570}
\begin{aligned}
I(\alpha + 1)
...
\begin{equation}\label{eqn:basicStatMechLecture2:660}
\begin{aligned}
0
&= \evalbar{f'(y)}{y^\conj} \\
&= -1 + \frac{\alpha}{y^\conj},
...
\begin{equation}\label{eqn:basicStatMechLecture2:780}
\begin{aligned}
f''(y)
...
\begin{equation}\label{eqn:basicStatMechLecture2:720}
\begin{aligned}
I(\alpha \gg 1) 
&\approx
e^{f(y^\conj)}
...
%
That is
\begin{equation}\label{eqn:basicStatMechLecture2:820c}
\begin{aligned}
\int_0^\infty dy
e^{
-\frac{(y - \alpha)^2}{2 \alpha }
