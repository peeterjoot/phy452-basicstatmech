...
\begin{equation}\label{eqn:relativisticDensityOfStates:20}
\epsilon = \sqrt{
\lr{m c^2}^2
+ (p c)^2 }.
\end{equation}
...
\begin{equation}\label{eqn:relativisticDensityOfStates:40}
\begin{aligned}
\calD_3(\epsilon)
&=
\sum_\Bp
...
%
Now we want to use
\begin{equation}\label{eqn:relativisticDensityOfStates:60}
\delta(g(x))
...
\begin{equation}\label{eqn:relativisticDensityOfStates:80}
g( cp ) = \epsilon - \sqrt{
\lr{ m c^2 }^2
+ ( c p )^2 }.
\end{equation}
...
\begin{equation}\label{eqn:relativisticDensityOfStates:100}
c p^\conj
=
\sqrt{ \epsilon^2 -
\lr{ m c^2 }^2
...
%
we have
\begin{equation}\label{eqn:relativisticDensityOfStates:140}
\begin{aligned}
...
\begin{equation}\label{eqn:relativisticDensityOfStates:160}
\begin{aligned}
\calD_3(\epsilon)
&=
...
\begin{equation}\label{eqn:relativisticDensityOfStates:340}
\calD_3(\epsilon)
=
\frac{4 \pi V}{ (c h)^3 }
\lr{
...
%
For 2D we have
\begin{equation}\label{eqn:relativisticDensityOfStates:200}
\begin{aligned}
\calD_2(\epsilon)
&=
...
\begin{equation}\label{eqn:relativisticDensityOfStates:220}
\calD_2(\epsilon)
=
\frac{2 \pi A}{ (c h)^2 }
...
%
\paragraph{1D case}
\begin{equation}\label{eqn:relativisticDensityOfStates:280}
\begin{aligned}
...
\begin{equation}\label{eqn:relativisticDensityOfStates:321}
\begin{aligned}
\sum_\Bk f(\Bk)
