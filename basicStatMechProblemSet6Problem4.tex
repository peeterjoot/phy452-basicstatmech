...
%(3 points)
Model a neutron star as an ideal Fermi gas of neutrons at \(T = 0\) moving in the gravitational field of a heavy point mass \(M\) at the centre. Show that the pressure \(P\) obeys the equation
\begin{dmath}\label{eqn:basicStatMechProblemSet6Problem4:20}
\frac{dP}{dr} = - \gamma M \frac{\rho(r)}{r^2},
\end{dmath}

where \(\gamma\) is the gravitational constant, \(r\) is the distance from the centre, and \(\rho(r)\) is the density which only depends on distance from the centre.
} % makeoproblem
