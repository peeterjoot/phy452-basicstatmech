...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem1:260}
\begin{aligned}
\Delta F
&= F( X + \Delta X ) - F(X) \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem1:180}
\begin{aligned}
dF
&= dU - T dS - S dT \\
&= -P dV - S dT \\
&= \lr{\PD{T}{F}}_V dT + \lr{\PD{V}{F}}_T dV.
\end{aligned}
\end{equation}
%
Forming the \textAndIndex{wedge product} with \(dT\), we arrive at the two form
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem1:200}
\begin{aligned}
0 
&=
\lr{
