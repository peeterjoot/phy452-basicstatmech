...
\begin{equation}\label{eqn:hyperSphereVolume:180}
\begin{aligned}
\iint e^{-(x^2 +y^2)/2} dx dy = (\sqrt{2 \pi})^2
&= 2 B \int_0^\infty dr r e^{-r^2/2} \\
&= -2 B \evalrange{e^{-r^2/2}}{0}{\infty} \\
&= 2 B.
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:hyperSphereVolume:240}
...
\begin{equation}\label{eqn:hyperSphereVolume:260}
...
\begin{equation}\label{eqn:hyperSphereVolume:220}
V_{m}
=
\frac{ \pi^{m/2} R^{m} }
{
