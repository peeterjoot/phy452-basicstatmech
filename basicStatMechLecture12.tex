...
\begin{equation}\label{eqn:basicStatMechLecture12:120a}
\begin{aligned}
Z
...
%
This gives us
\begin{equation}\label{eqn:basicStatMechLecture12:120}
\begin{aligned}
Z
...
\begin{equation}\label{eqn:basicStatMechLecture12:200}
\begin{aligned}
\expectation{E} 
&= \frac{\sum_{\{c\}} E(c) e^{-\beta E(c)}} {\sum_{\{c\}} e^{-\beta E(c)}} \\
&= - \PD{\beta}{}\ln Z \\
&= \PD{\beta}{(\beta F)}.
\end{aligned}
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture12:280}
\begin{aligned}
\Omega(E)
&=
\mathLabelBox{
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture12:300}
\begin{aligned}
Z
&= \sum_m e^{-\beta \calE_m} \\
...
\begin{equation}\label{eqn:basicStatMechLecture12:320}
S_z = \pm \inv{2} \Hbar,
\end{equation}
where \(S_z\) is the magnitude of the spin operator
\begin{equation}\label{eqn:basicStatMechLecture12:321}
\hat{S}_z = \pm \inv{2} \Hbar \hat{\sigma}_z,
\end{equation}
and \(\hat{\sigma}_z\) is the Pauli matrix.  Dropping \(\Hbar\) we have
\begin{equation}\label{eqn:basicStatMechLecture12:340}
...
\begin{equation}\label{eqn:basicStatMechLecture12:460}
\begin{aligned}
Z
&= \sum_{\{\sigma\}} e^{-\beta
...
\begin{equation}\label{eqn:basicStatMechLecture12:520}
\begin{aligned}
\expectation{S_{z_i}}
&=
\frac
