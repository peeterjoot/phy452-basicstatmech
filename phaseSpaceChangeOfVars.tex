...
%\section{Motivation}
%
\makeproblem{2D phase space, Cartesian to cylindrical.}{pr:phaseSpaceChangeOfVars:1}{
...
\begin{equation}\label{eqn:phaseSpaceChangeOfVars:20}
