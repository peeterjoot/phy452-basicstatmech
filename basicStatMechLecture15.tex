...
\begin{equation}\label{eqn:basicStatMechLecture15:20}
...
%
Our Hamiltonian is
\begin{equation}\label{eqn:basicStatMechLecture15:40}
H = \sum_k \hat{n}_k \epsilon_k,
\end{equation}
where we have a number operator
\begin{equation}\label{eqn:basicStatMechLecture15:60}
N = \sum \hat{n}_k,
\end{equation}
such that
\begin{equation}\label{eqn:basicStatMechLecture15:80}
\antisymmetric{N}{H} = 0.
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture15:100}
\ZG
...
\begin{equation}\label{eqn:basicStatMechLecture15:120}
\begin{aligned}
\ZG
&= \sum_{n_k} e^{\beta \mu \sum_m n_m} e^{-\beta \sum_n n_n \epsilon_n} \\
&= \sum_{n_k} e^{-\beta \sum_m (\epsilon_m - \mu) n_m} \\
...
%
\paragraph{Fermions}
\begin{equation}\label{eqn:basicStatMechLecture15:140}
...
%
\paragraph{Bosons}
\begin{equation}\label{eqn:basicStatMechLecture15:160}
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture15:180}
\ZG^f = \prod_k
\lr{ 1 + e^{-\beta(\epsilon_k - \mu)} }
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture15:200}
\ZG^b = \prod_k
...
\begin{equation}\label{eqn:basicStatMechLecture15:220}
\begin{aligned}
\expectation{n_k^f}
&= \frac{1 \times 0 + e^{-\beta(\epsilon_k - \mu)} \times 1} { 1 + e^{-\beta(\epsilon_k - \mu)} } \\
...
%
For Bosons we have
\begin{equation}\label{eqn:basicStatMechLecture15:240}
\expectation{n_k^b}
= \frac{
0 \times 1
+
...
\begin{equation}\label{eqn:basicStatMechLecture15:260}
e^{\beta \mu} \equiv z,
\end{equation}
is called the \underlineAndIndex{fugacity}.  The denominator has the form
\begin{equation}\label{eqn:basicStatMechLecture15:280}
D =
1
+ z e^{-\beta \epsilon_k}
...
\end{equation}
so we see that
\begin{equation}\label{eqn:basicStatMechLecture15:300}
\begin{aligned}
z \PD{z}{D}
&=
  z e^{-\beta \epsilon_k}
...
\begin{equation}\label{eqn:basicStatMechLecture15:320}
N = z \PD{z}{D}.
\end{equation}
%
Proceeding
\begin{equation}\label{eqn:basicStatMechLecture15:340}
\begin{aligned}
\expectation{n_k^b}
&= \frac{z \PD{z}{D_k} }{D_k} \\
&= z \PD{z}{} \ln D_k \\
&= -z \PD{z}{} \ln \lr{ 1 - z e^{-\beta \epsilon_k} } \\
&= z \frac{ e^{-\beta \epsilon_k} } { 1 - z e^{-\beta \epsilon_k} } \\
...
%
For Fermions
\begin{equation}\label{eqn:basicStatMechLecture15:360}
\begin{aligned}
\rho 
&= \frac{N}{V}  \\
&= \inv{V} \sum_{\Bk} \inv{ e^{\beta(\epsilon_\Bk - \mu)} + 1}.
\end{aligned}
\end{equation}
The simplest such system is the ``free particle in a box'', with Hamiltonian
\begin{equation}\label{eqn:basicStatMechLecture15:620}
...
\begin{equation}\label{eqn:basicStatMechLecture15:640}
\Psi =
...
\begin{equation}\label{eqn:basicStatMechLecture15:660}
...
\begin{equation}\label{eqn:basicStatMechLecture15:680}
\begin{aligned}
\inv{V} \sum_\Bk f_{\Bk}
&\approx \inv{V} \inv{2^3} \int dn_x dn_y dn_y f_\Bn \\
...
\begin{equation}\label{eqn:basicStatMechLecture15:400}
...
\begin{equation}\label{eqn:basicStatMechLecture15:560}
\epsilon_k = E_{\txtF},
\end{equation}
or
\begin{equation}\label{eqn:basicStatMechLecture15:440}
E_{\txtF} = \frac{\Hbar^2 k_{\txtF}^2}{2m}.
\end{equation}
With this definition
\begin{equation}\label{eqn:basicStatMechLecture15:460}
k_{\txtF} = \sqrt{\frac{2 m E_{\txtF}}{\Hbar^2}},
\end{equation}
so that our density where \(\epsilon_k = \mu\) is
\begin{equation}\label{eqn:basicStatMechLecture15:480}
\begin{aligned}
\rho
...
\end{equation}
so that
\begin{equation}\label{eqn:basicStatMechLecture15:500}
...
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture15:540}
\rho^{-1/3} = \mbox{interparticle spacing}.
\end{equation}
We can convince our self that the chemical potential must have the form \cref{fig:lecture15:lecture15Fig3}.
...
\begin{equation}\label{eqn:basicStatMechLecture15:580}
...
\begin{equation}\label{eqn:basicStatMechLecture15:700}
e^{\beta \mu} =
%\frac{4}{3}
\rho \lambda_T^3,
\end{equation}
...
\begin{equation}\label{eqn:basicStatMechLecture15:600}
