...
\end{subequations}
we have
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:80}
\begin{aligned}
Z_1
&=
\inv{h \omega}
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:140}
\begin{aligned}
U
&= \inv{\kB} \PD{\beta}{} \lr{ \frac{F}{T} } \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:200}
\begin{aligned}
Z_1
&=
...
\end{equation}
our mean energy is
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:260}
\begin{aligned}
U
&= \inv{\kB} \PD{\beta}{} \frac{F}{T} \\
&= N \PD{\beta}{} \ln \sinh(\beta \Hbar \omega/2) \\
&= N \frac{\cosh( \beta \Hbar \omega/2 )}{ \sinh(\beta \Hbar \omega/2) } \frac{\Hbar \omega}{2},
\end{aligned}
\end{equation}
or
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:300}
\begin{aligned}
\CV
&= \PD{T}{U} \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem2:460}
\begin{aligned}
\lim_{T \rightarrow 0} \CV
&= N \kB \lim_{x \rightarrow \infty} \frac{x^2}{\sinh^2 x} \\
&= N \kB \lim_{x \rightarrow \infty} \frac{2x }{2 \sinh x \cosh x} \\
&= N \kB \lim_{x \rightarrow \infty} \frac{1 }{\cosh^2 x + \sinh^2 x} \\
&= N \kB \lim_{x \rightarrow \infty} \frac{1 }{\cosh (2 x) } \\
&= 0.
\end{aligned}
\end{equation}
%
