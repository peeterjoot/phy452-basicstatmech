...
%
\makeoproblem{3D spherical phase space}{pr:phaseSpaceChangeOfVarsSpherical:1}{\citep{pathriastatistical} pr. 2.2 (a)}{
...
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:20}
\begin{aligned}
\LL
...
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:100}
\begin{aligned}
H 
&= \inv{2} m \lr{
\lr{\frac{p_r}{m}}^2
...
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:300}
\begin{aligned}
d\omega
&= dr d\theta d\phi dp_r dp_\theta dp_\phi \\
&= \frac{\partial(r, \theta, \phi, p_r, p_\theta, p_\phi)}{\partial(x, y, z, p_x, p_y, p_z)} dx dy dz dp_x dp_y dp_z,
\end{aligned}
\end{equation}
but
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:300a}
...
\end{equation}
where
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:320}
A =
\begin{bmatrix}
 \frac{x}{r} & \frac{y}{r} & \frac{z}{r} \\
 \frac{x z}{\rho r^2} & \frac{y z}{\rho r^2} & -\frac{\rho}{r^2} \\
 -\frac{y}{\rho^2} & \frac{x}{\rho^2} & 0 
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:340}
B =
\begin{bmatrix}
 \frac{\left(y^2+z^2\right) p_x-x y p_y-x z p_z}{r^3} & \frac{\left(x^2+z^2\right) p_y-y \left(x p_x+z p_z\right)}{r^3} & \frac{\left(\rho^2\right) p_z-z \left(x p_x+y p_y\right)}{r^3}  \\
 \frac{y z \left(y p_x-x p_y\right)-x \left(\rho^2\right) p_z}{\rho^3} & \frac{x z \left(x p_y-y p_x\right)-y \left(\rho^2\right) p_z}{\rho^3} & \frac{x p_x+y p_y}{\rho}  \\
 p_y & -p_x & 0 
\end{bmatrix}
\end{equation}
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:360}
C =
\begin{bmatrix}
\frac{x}{r} & \frac{y}{r} & \frac{z}{r} \\
\frac{x z}{\rho} & \frac{y z}{\rho} & -\rho \\
-y & x & 0 \\
\end{bmatrix}.
\end{equation}
%
...
\begin{equation}\label{eqn:phaseSpaceChangeOfVarsSpherical:300b}
