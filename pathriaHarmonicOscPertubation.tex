...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:20}
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:40}
\frac{3}{2} \kB^2 \lr{
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:60}
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:80}
\begin{aligned}
Z
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:100}
A(f, g) = e^{ -\beta \lr{ c q^2 - g q^3 - f q^4} }
\end{equation}
%
The expansion to second order is
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:120}
\begin{aligned}
A(f, g)
&=
A(0, 0)
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:140}
\begin{aligned}
...
%
This gives us
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:160}
\begin{aligned}
Z 
&=
\sqrt{ \frac{\pi}{\beta c} }
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:180}
\begin{aligned}
\expectation{H}
&= -\PD{\beta}{} \ln Z \\
&\approx -\PD{\beta}{}
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:200}
\begin{aligned}
\CV 
&= \PD{T}{\expectation{H}} \\
&\approx \kB + 2 \kB^2 T \lr{ \frac{3 f}{4 c^2} + \frac{15 g^2}{16 c^3} },
\end{aligned}
\end{equation}
or
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:260}
\begin{aligned}
\expectation{q}
&=
\sqrt{\frac{2 \pi m}{\beta} }
...
\begin{equation}\label{eqn:pathriaHarmonicOscPertubation:300}
