...
\begin{equation}\label{eqn:kittelChapter3:60}
\begin{aligned}
U
&= \tau^2 \PD{\tau}{} \ln Z_N \\
&= \tau^2 \PD{\tau}{} \left( N \ln Z_1 - \ln N! \right) \\
&= N \tau^2 \PD{\tau}{\ln Z_1 } \\
&= N \tau^2 \PD{\tau}{} \sum_{k = 1}^{3} \ln \int \exp\left( - \frac{p_k^2 }{2 M \tau} \right) dp_k \\
&= N \tau^2 \sum_{k = 1}^{3} \frac{ \PD{\tau}{} \int \exp\left( - \frac{p_k^2 }{2 M \tau} \right) dp_k } { \int \exp\left( - \frac{p_k^2 }{2 M \tau} \right) dp_k } \\
&= N \tau^2 \sum_{k = 1}^{3} \frac{ \PD{\tau}{} \sqrt{ 2 \pi M \tau } } { \sqrt{ 2 \pi M \tau} } \\
&= 3 N \tau^2 \frac{ \inv{2} \tau^{-1/2} } { \sqrt{ \tau} } \\
&= \frac{3}{2} N \tau \\
&= \frac{3}{2} N \kB T.
\end{aligned}
\end{equation}
...
%
\makeoproblem{Two state system}{pr:kittelChapter3:1}{\citep{kittel1980thermal} pr. 3.1}{
...
\begin{equation}\label{eqn:kittelChapter3:100}
F = -\tau \ln Z = -\tau \ln (1 + e^{-\epsilon/\tau}).
\end{equation}
%
The entropy follows immediately
\begin{equation}\label{eqn:kittelChapter3:120}
\begin{aligned}
\sigma
&= -\PD{\tau}{F} \\
&= \PD{\tau}{} \lr{ \tau \ln \lr{1 + e^{-\epsilon/\tau}} } \\
&= \ln \lr{1 + e^{-\epsilon/\tau}} - \tau \epsilon \frac{-1}{\tau^2} \inv{1 + e^{-\epsilon/\tau}} \\
&= \ln \lr{1 + e^{-\epsilon/\tau}} + \frac{\epsilon}{\tau} \frac{e^{-\epsilon/\tau}}{1 + e^{-\epsilon/\tau}}.
\end{aligned}
\end{equation}
%
The energy is
\begin{equation}\label{eqn:kittelChapter3:140}
\begin{aligned}
U
&= F + \tau \sigma \\
&= -\tau \ln (1 + e^{-\epsilon/\tau}) + \tau \sigma \\
&= \tau \lr{ \cancel{\ln \lr{1 + e^{-\epsilon/\tau}}} + \frac{\epsilon}{\tau} \frac{e^{-\epsilon/\tau}}{1 + e^{-\epsilon/\tau}} -\cancel{\ln (1 + e^{-\epsilon/\tau}) } }.
\end{aligned}
\end{equation}
%
This is
...
%
\makeoproblem{Magnetic susceptibility}{pr:kittelChapter3:2}{\citep{kittel1980thermal} pr. 3.2}{
%
...
\begin{equation}\label{eqn:kittelChapter3:220}
\begin{aligned}
- M B 
&= U \\
&= \tau^2 \PD{\tau}{} \lr{-\frac{F}{\tau}} \\
&= \tau^2 n \PD{\tau}{} \ln \cosh\lr{m B/\tau} \\
&= \tau^2 n \frac{ -m B/\tau^2 \sinh \lr{m B/\tau} }{ \cosh \lr{m B/\tau} } \\
&= - m B n \tanh \lr{m B/\tau}.
\end{aligned}
\end{equation}
%
...
%
\makeoproblem{Free energy of a harmonic oscillator}{pr:kittelChapter3:3}{\citep{kittel1980thermal} pr. 3.3}{
%
...
%
The free energy is
\begin{equation}\label{eqn:kittelChapter3:380}
\begin{aligned}
F
&= -\tau \ln Z \\
&= -\tau \lr{ -\frac{\Hbar \omega}{2\tau} + \ln \lr{ \sum_{s = 0}^\infty e^{-s \Hbar \omega/\tau} } } \\
&= \frac{\Hbar \omega}{2} + \ln \lr{ \sum_{s = 0}^\infty e^{-s \Hbar \omega/\tau} }.
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:kittelChapter3:420}
\begin{aligned}
\sigma 
&= -\PD{\tau}{F} \\
&= -\ln \lr{ 1 - e^{-\Hbar \omega/\tau} } + \tau \frac{\Hbar \omega}{\tau^2} \frac{e^{-\Hbar \omega/\tau}}{ 1 - e^{-\Hbar \omega/\tau} } \\
&= -\ln \lr{ 1 - e^{-\Hbar \omega/\tau} } + \frac{ \frac{\Hbar \omega}{\tau} }{ e^{\Hbar \omega/\tau} - 1 }.
\end{aligned}
\end{equation}
} % makeanswer
%
\makeoproblem{Energy fluctuation}{pr:kittelChapter3:4}{\citep{kittel1980thermal} pr. 3.4}{
%
...
\begin{equation}\label{eqn:kittelChapter3:460}
\begin{aligned}
U
&= \expectation{\epsilon} \\
&= \sum_s P_s \epsilon_s \\
...
%
So we have
\begin{equation}\label{eqn:kittelChapter3:480}
\begin{aligned}
\tau^2 \PD{\tau}{U}
&= -\frac{\tau^2}{Z^2} \frac{dZ}{d\tau} \sum_s \epsilon_s e^{-\epsilon_s/\tau} + \frac{\tau^2}{Z} \sum_s \frac{\epsilon_s^2}{\tau^2} e^{-\epsilon_s/\tau} \\
&= -\frac{\tau^2}{Z^2} \frac{dZ}{d\tau} \sum_s \epsilon_s e^{-\epsilon_s/\tau} + \inv{Z} \sum_s \epsilon_s^2 e^{-\epsilon_s/\tau}.
\end{aligned}
\end{equation}
%
But
\begin{equation}\label{eqn:kittelChapter3:520}
\begin{aligned}
\frac{dZ}{d\tau}
...
\end{equation}
giving
\begin{equation}\label{eqn:kittelChapter3:540}
\begin{aligned}
\tau^2 \PD{\tau}{U}
&= \frac{1}{Z^2} \sum_s \epsilon_s e^{-\epsilon_s/\tau} \sum_s \epsilon_s e^{-\epsilon_s/\tau} + \inv{Z} \sum_s \epsilon_s^2 e^{-\epsilon_s/\tau} \\
