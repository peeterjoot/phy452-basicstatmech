...
\begin{equation}\label{eqn:basicStatMechLecture17:220}
...
\begin{equation}\label{eqn:basicStatMechLecture17:240}
...
\imageFigure{../figures/phy452-basicstatmech/lecture17Fig3}{Graphene bond structure.}{fig:lecture17:lecture17Fig3}{0.2}
\imageFigure{../figures/phy452-basicstatmech/lecture17Fig4}{Graphene energy momentum dependence.}{fig:lecture17:lecture17Fig4}{0.2}
\begin{equation}\label{eqn:basicStatMechLecture17:260}
...
\begin{equation}\label{eqn:basicStatMechLecture18:340}
\epsilon_\Bk = \pm \Hbar v \Abs{\Bk}.
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:360}
...
\imageFigure{../figures/phy452-basicstatmech/lecture18Fig5}{Relativistic gas energy distribution.}{fig:lecture18:lecture18Fig5}{0.2}
%
...
\begin{equation}\label{eqn:basicStatMechLecture18:380}
...
\begin{equation}\label{eqn:basicStatMechLecture18:400}
N(\epsilon) = \text{constant factor} \frac{\Abs{\epsilon}}{v},
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:420}
C \sim \frac{d}{dT} \int N(\epsilon) n_{\txtF}(\epsilon) \epsilon d\epsilon,
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:440}
\begin{aligned}
\Delta E 
&\sim 
\mathLabelBox
...
\end{equation}
so that
\begin{equation}\label{eqn:basicStatMechLecture18:460}
