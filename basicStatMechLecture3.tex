...
\begin{aligned}
\expectation{X^2}
&= \expectation{ \sum_{i = 1}^N \delta x_i \sum_{j = 1}^N \delta x_j } \\
...
\begin{equation}\label{eqn:basicStatMechLecture3:100}
\begin{aligned}
\calP( x, t )
&=
...
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture3:140}
