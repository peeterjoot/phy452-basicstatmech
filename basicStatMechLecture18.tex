...
\begin{equation}\label{eqn:basicStatMechLecture18:20}
\mu =
...
\begin{equation}\label{eqn:basicStatMechLecture18:40}
E = \sum_\Bk n_{\txtF}(\epsilon_\Bk, T) \epsilon_\Bk
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:60}
\begin{aligned}
\frac{E}{V}
...
\end{equation}
where
\begin{equation}\label{eqn:basicStatMechLecture18:80}
...
\begin{equation}\label{eqn:basicStatMechLecture18:100}
\frac{\Delta E(T)}{V}
=
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture18:120}
N(\epsilon) \approx N(\mu)
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:140}
\mu \approx \epsilon_{\txtF},
\end{equation}
\end{subequations}
so that
\begin{equation}\label{eqn:basicStatMechLecture18:160}
\begin{aligned}
\Delta e
&\equiv
\frac{\Delta E(T)}{V} \\
...
\begin{equation}\label{eqn:basicStatMechLecture18:180}
\begin{aligned}
\Delta e
&=
N(\epsilon_{\txtF})
...
\begin{equation}\label{eqn:basicStatMechLecture18:200}
\begin{aligned}
\frac{\delta e}{T}
&=
-N(\epsilon_{\txtF})
...
\begin{equation}\label{eqn:basicStatMechLecture18:220}
\begin{aligned}
\frac{C}{V}
&=
N(\epsilon_{\txtF})
...
\begin{subequations}
\begin{equation}\label{eqn:basicStatMechLecture18:240}
\frac{N}{V} = \rho
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:260}
\epsilon_{\txtF} = \frac{\Hbar^2 \kF^2}{2 m}
\end{equation}
\begin{equation}\label{eqn:basicStatMechLecture18:280}
\kF = \lr{6 \pi^2 \rho}
^{1/3},
\end{equation}
\end{subequations}
we have
\begin{equation}\label{eqn:basicStatMechLecture18:320}
\begin{aligned}
N(\epsilon_{\txtF})
&= \inv{4 \pi^2}
\lr{\frac{2m}{\Hbar^2}}
...
%
Giving
\begin{equation}\label{eqn:basicStatMechLecture18:480}
\begin{aligned}
\frac{C}{N}
&=
\frac{\pi^2}{3}
