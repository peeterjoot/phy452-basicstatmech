...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:60}
\begin{aligned}
\calD(\epsilon)
&=
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:100}
\begin{aligned}
N
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:180}
\begin{aligned}
P V \beta
&=
g \sum \ln
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:220}
\begin{aligned}
U
&= - \PD{\beta}{} \ln \ZG \\
...
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:280}
\frac{P \beta}{n} =
\frac{f_{5/2}(z)}{
f_{3/2}(z)
},
\end{equation}
to find
\begin{equation}\label{eqn:fermiFunctionExpansionsForNandP:300}
\begin{aligned}
U
