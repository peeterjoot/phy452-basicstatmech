...
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:460}
N_d(\epsilon) \equiv
\sum_\Bk
...
%
We'll use
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:440}
\delta(g(x)) = \sum_{x_0} \frac{\delta(x - x_0)}{\Abs{g'(x_0)}},
\end{equation}
where the roots of \(g(x)\) are \(x_0\).  With
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:480}
g(k) = \epsilon - \frac{\Hbar^2 k^2}{2 m},
\end{equation}
the roots \(k^\conj\) of \(g(k) = 0\) are
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:500}
k^\conj = \pm \sqrt{\frac{2 m \epsilon }{\Hbar^2}}.
\end{equation}
%
The derivative of \(g(k)\) evaluated at these roots are
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:520}
\begin{aligned}
g'(k^\conj) 
...
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:540}
\begin{aligned}
N_2(\epsilon)
&=
...
%
In 1D we have
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:580}
\begin{aligned}
N_1(\epsilon)
&=
...
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:620}
\begin{aligned}
\rho
&= \frac{N}{A} \\
&= \frac{1}{A} A \int \frac{d^2 \Bk}{(2 \pi)^2} f(e_\Bk) \\
&= \frac{1}{A} \frac{2 \pi A m}{h^2} \int_0^\infty d\epsilon \inv{ z^{-1} e^{\beta \epsilon} -1 } \\
&= \frac{2 \pi m}{h^2 \beta} \int_0^\infty dx \inv{ z^{-1} e^{x} -1 } \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:660}
\begin{aligned}
\rho
&= \frac{N}{L} \\
&= \frac{1}{L} L \int \frac{dk}{2 \pi} f(e_\Bk) \\
&= \frac{1}{L} \frac{2 L}{h} \sqrt{\frac{m}{2}} \int_0^\infty d\epsilon \inv{\sqrt{\epsilon}} \inv{ z^{-1} e^{\beta \epsilon} -1 } \\
&= \inv{h} \sqrt{\frac{2 m}{\beta}} \int_0^\infty \frac{x^{1/2 - 1}}{z^{-1} e^x - 1} \\
&= \inv{h} \sqrt{\frac{2 m}{\beta}} \Gamma(1/2) f^-_{1/2}(z),
\end{aligned}
\end{equation}
or
\begin{equation}\label{eqn:basicStatMechProblemSet7Problem1:680}
\rho
=
