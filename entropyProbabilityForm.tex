...
\begin{equation}\label{eqn:entropyProbabilityForm:20}
S = - \kB \sum_i P_i \ln P_i,
\end{equation}
where
\begin{subequations}
\begin{equation}\label{eqn:entropyProbabilityForm:40}
P_i = \frac{e^{-\beta E_i}}{Z}
\end{equation}
\begin{equation}\label{eqn:entropyProbabilityForm:60}
Z = \sum_i e^{-\beta E_i}.
\end{equation}
\end{subequations}
...
\begin{equation}\label{eqn:entropyProbabilityForm:80}
\begin{aligned}
\frac{S}{\kB}
&= \frac{U - F}{\kB T} \\
&= \beta \lr{ -\PD{\beta}{\ln Z}} - \beta \lr{-\kB T \ln Z} \\
&= \frac{\sum_i \beta E_i e^{-\beta E_i}}{Z} +\ln Z \\
...
%
\makeoproblem{Entropy, grand canonical scheme}{pr:entropyProbabilityForm:2}{
...
\end{subequations}
and show
\begin{equation}\label{eqn:entropyProbabilityForm:180}
...
\begin{equation}\label{eqn:entropyProbabilityForm:240}
\begin{aligned}
\frac{S}{\kB}
