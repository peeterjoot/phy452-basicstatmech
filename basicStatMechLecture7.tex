...
\begin{equation}\label{eqn:basicStatMechLecture7:160}
\begin{aligned}
...
\end{equation}
so
\begin{equation}\label{eqn:basicStatMechLecture7:240}
\begin{aligned}
...
%
Our phase space is of the form \cref{fig:basicStatMechLecture4:basicStatMechLecture4Fig4},
%\cref{fig:lecture71DclassicalSHOphasespace:lecture71DclassicalSHOphasespaceFig3}.
%
...
\begin{equation}\label{eqn:basicStatMechLecture7:440d}
E - n \Hbar \omega > 0,
\end{equation}
%
or
\begin{equation}\label{eqn:basicStatMechLecture7:440b}
\frac{E}{\Hbar \omega} > n.
\end{equation}
%
This gives us
\begin{equation}\label{eqn:basicStatMechLecture7:440c}
\begin{aligned}
\gamma_{\mathrm{quantum}}(E \gg \Hbar \omega)
&\approx
...
\end{equation}
or
\begin{equation}\label{eqn:basicStatMechLecture6:380d}
S =
\kB N \lr{
\ln \lr{ \frac{V}{h^3}
...
\end{itemize}
This is fine in the classical picture, but in the quantum picture with an assumption of indistinguishably, no two particles (say electrons) cannot be labeled in this fashion.
%
\paragraph{Gibbs paradox}
\index{Gibbs paradox}
\begin{equation}\label{eqn:basicStatMechLecture7:460}
\mathLabelBox
[
   labelstyle={xshift=2cm},
   linestyle={out=270,in=90, latex-}
...
\begin{equation}\label{eqn:basicStatMechLecture7:480}
\begin{aligned}
