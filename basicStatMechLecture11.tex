...
\begin{equation}\label{eqn:basicStatMechLecture11:80}
\begin{aligned}
\Omega&(N, E) \\
&=
\frac{V^N}{h^{3N} N!}
...
\imageFigure{../figures/phy452-basicstatmech/lecture11Fig1}{Partitioning out a subset of a larger system.}{fig:lecture11:lecture11Fig1}{0.2}
%
...
\end{equation}
we have
\begin{equation}\label{eqn:basicStatMechLecture11:260}
\begin{aligned}
\Omega(N, V, E) 
&=
\int
...
d\{x_2\}
d\{p_2\} \times \\
&\qquad \delta( E - H_1 - H_2 ) \inv{ h^{3N_1} N_1! h^{3 N_2} N_2!} \\
&\propto
\int
d\{x_1\}
d\{p_1\}
...
\imageFigure{../figures/phy452-basicstatmech/lecture11Fig2}{Larger system partitioned into many small subsystems.}{fig:lecture11:lecture11Fig2}{0.2}
...
&= \PD{T}{\expectation{E}} \PD{\beta}{T} \\
&= -\PD{T}{\expectation{E}} \PD{\beta}{} \inv{\kB \beta} \\
&= \PD{T}{\expectation{E}} \inv{\kB \beta^2} \\
