...
%
\makeoproblem{Large N limit for unfair coin}{pr:unfairCoinDistributionHardWay:1}{2013 ps1, p2}{
...
\begin{equation}\label{eqn:unfairCoinLimitHardWay:60}
\begin{aligned}
P_N(r, k)
&\approx
\frac{
...
\begin{equation}\label{eqn:unfairCoinLimitHardWay:180}
\begin{aligned}
\frac{(N - k) k}{N}
&= \inv{N}(N r - x)(N s + x) \\
...
\begin{equation}\label{eqn:unfairCoinLimitHardWay:200}
\begin{aligned}
\ln P_N(r, k)
&\approx
...
\begin{equation}\label{eqn:unfairCoinLimitHardWay:220}
\begin{aligned}
-\inv{2}
\lr{ \inv{r} + \inv{s} }
&= -\inv{2 r s} \lr{ r + (1 - r) } \\
...
%
With
\begin{equation}\label{eqn:unfairCoinLimitHardWay:260}
\begin{aligned}
x
&= k - N s \\
&= \inv{2} ( N + X ) - N s \\
