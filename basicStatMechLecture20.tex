...
Bose condensation occurs for \(T < T_{\mathrm{BEC}}\).
\index{Bose-Einstein condensate}
At this point our number density becomes (except at \(\Bk = 0\))
...
\begin{equation}\label{eqn:basicStatMechLecture20:40}
\begin{aligned}
N
&= N_0 + \sum_{\Bk \ne 0} n(\Bk) \\
&= N_0 + V
...
% FIXME: reference
\begin{equation}\label{eqn:basicStatMechLecture20:100}
...
\end{equation}
% lecture20PlotAndIntegral.nb
This is plotted in \cref{fig:lecture20:lecture20Fig2}.
\imageFigure{../figures/phy452-basicstatmech/lecture20Fig2x}{Boson density variation with temperature.}{fig:lecture20:lecture20Fig2}{0.2}
\begin{equation}\label{eqn:basicStatMechLecture20:140}
\rho_0 = \frac{N_{\Bk = 0}}{V}.
\end{equation}
%
For \(T \ge T_{\mathrm{BEC}}\), we have \(\rho_0 = 0\).  This condensation temperature is
\begin{equation}\label{eqn:basicStatMechLecture20:160}
...
\begin{equation}\label{eqn:basicStatMechLecture20:180}
\begin{aligned}
\frac{E}{V}
...
\end{equation}
so that
\begin{equation}\label{eqn:basicStatMechLecture20:200}
\frac{C}{V} \propto
\lr{\kB T}^
{3/2}.
\end{equation}
...
%
Writing
\begin{equation}\label{eqn:basicStatMechLecture20:220}
\lambda =
\left\{
\begin{array}{l l}
...
\begin{equation}\label{eqn:basicStatMechLecture20:240}
n_{\Bk, \lambda}
=
...
\begin{equation}\label{eqn:basicStatMechLecture20:280}
\begin{aligned}
\frac{E}{V}
&=
...
\begin{equation}\label{eqn:basicStatMechLecture20:320}
\int_0^\infty d\epsilon \frac{\epsilon^3}{e^{\beta \epsilon} - 1} =
\frac{\pi ^4}{15 \beta ^4},
\end{equation}
for an end result of
\begin{equation}\label{eqn:basicStatMechLecture20:300}
\frac{E}{V}
=
