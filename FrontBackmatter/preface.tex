...
%
This book contains lecture notes taken during the Winter 2013 session of
Basic Statistical Mechanics (PHY452H1S), a University of Toronto course that was 
taught by Prof.\ Arun Paramekanti.
%This book contains my lecture notes for the Winter 2013, University of Toronto Basic Statistical Mechanics course (PHY452H1S), taught by Prof.\ Arun Paramekanti.
%
\paragraph{Official course description:}
%
``Classical and quantum statistical mechanics of non-interacting systems; the statistical basis of thermodynamics; ensembles, partition function; thermodynamic equilibrium; stability and fluctuations; formulation of quantum statistics; theory of simple gases; ideal Bose and Fermi systems.''
%
...
%
\item Some worked problems attempted as course prep, for fun, for test preparation, or post test reflection.
%
