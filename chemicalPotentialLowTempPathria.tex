...
If we are looking for an approximation in the neighbourhood of \(\mu = \EF\), then the LHS factor is approximately one, whereas the fractional difference term is large (with a corresponding requirement for \(\kB T/\EF\) to be small.  We must then have
