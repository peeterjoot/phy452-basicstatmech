...
\begin{equation}\label{eqn:relStatMechExploration:100}
N = \sum_i n_i.
\end{equation}
%
Only given a specific observer frame can these four-momentum components \(\lr{\epsilon_i/c, \Bp_i}\) be expressed explicitly, as in
\begin{subequations}
\begin{equation}\label{eqn:relStatMechExploration:40}
\epsilon_i = \gamma_i m_i c^2
\end{equation}
\begin{equation}\label{eqn:relStatMechExploration:60}
\Bp_i = \gamma_i m \Bv_i
\end{equation}
\begin{equation}\label{eqn:relStatMechExploration:80}
...
\begin{equation}\label{eqn:relStatMechExploration:120}
...
\begin{equation}\label{eqn:relStatMechExploration:140}
...
\begin{equation}\label{eqn:relStatMechExploration:160}
E^{(0)} = E_1 + E_2,
\end{equation}
so we'll write
...
\begin{equation}\label{eqn:relStatMechExploration:200}
...
\begin{equation}\label{eqn:relStatMechExploration:220}
\begin{aligned}
0 &=
...
\begin{equation}\label{eqn:relStatMechExploration:240}
...
\begin{equation}\label{eqn:relStatMechExploration:260}
\beta_\mu \equiv \PDc{P^\mu}{\ln \Omega(N, V, P)}{N, V, P = \overbar{P}}.
\end{equation}
%
Our old scalar temperature is then
\begin{equation}\label{eqn:relStatMechExploration:280}
...
\imageFigure{../figures/phy452-basicstatmech/relStatMechExplorationFig2}{A system \(A\) immersed in heat reservoir \(A'\).}{fig:relStatMechExploration:relStatMechExplorationFig2}{0.15}
%
...
\begin{equation}\label{eqn:relStatMechExploration:340}
\begin{aligned}
\ln \Omega'({P^\mu_r}') 
&= \ln \Omega'({P^{(0)}}) + \PDc{{P^\mu}'}{\ln \Omega'}{P' = P^{(0)}} \lr{ P^{(0)} - P^\mu} \\
&\approx \text{constant} - \beta_\mu' P^\mu.
\end{aligned}
\end{equation}
%
...
This looks consistent with the outline provided in \href{https://physics.stackexchange.com/a/4950/3621}{https://physics.stackexchange.com/a/4950/3621} by Lubos to the stackexchange ``is there a relativistic quantum thermodynamics'' question.
