...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:220}
\begin{aligned}
Z
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:260}
\begin{aligned}
Z \expectation{ \mu L_z }
&= \sum_{l = 0}^\infty \sum_{m = -l}^l \bra{l m} \mu L_z \ket{l m} e^{-\beta \lambda_{l, m}} \\
&= \sum_{l = 0}^\infty \sum_{m = -l}^l \mu \bra{l m} m \Hbar \ket{l m} e^{-\beta \lambda_{l, m}} \\
&= \mu \Hbar \sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \Hbar^2 \beta}{2 I}} \sum_{m = -l}^l m e^{ \mu m \Hbar \calE \beta} \\
&= \mu \Hbar \sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \Hbar^2 \beta}{2 I}} \sum_{m = 1}^l m \lr{ e^{ \mu m \Hbar \calE \beta} -e^{-\mu m \Hbar \calE \beta} } \\
&= 2 \mu \Hbar \sum_{l = 0}^\infty \exp\lr{ -\frac{l (l+1) \Hbar^2 \beta}{2 I}} \sum_{m = 1}^l m \sinh (\mu m \Hbar \calE \beta).
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:720}
\begin{aligned}
\expectation{ \mu L_z } 
&\approx
2 \mu \Hbar
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:740}
\begin{aligned}
\expectation{ \mu L_z } 
&\approx
\frac
...
% problemSet5Problem3partD.nb
\imageFigure{../figures/phy452-basicstatmech/basicStatMechProblemSet5Problem3Fig5A}{Low temperature dipole moment behavior.}{fig:basicStatMechProblemSet5Problem3:basicStatMechProblemSet5Problem3Fig5A}{0.2}
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:420}
\begin{aligned}
\sum_{m = -l}^l a^m
&= a^{-l} \sum_{n=0}^{2l} a^n \\
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:460}
\begin{aligned}
\sum_{m = -l}^l m a^m
&= a \lr{ \sum_{m = 1}^l + \sum_{m = -l}^{-1} } m a^{m-1} \\
&= a \frac{d}{da} \sum_{m = 1}^l \lr{ a^{m} + a^{-m} } \\
&= a \frac{d}{da} \lr{ \sum_{m = -l}^l a^m - \cancel{1} } \\
&= a \frac{d}{da} \lr{ \frac{a^{l + 1/2} - a^{-(l+1/2)}}{a^{1/2} - a^{-1/2}} }.
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:540}
\begin{aligned}
\expectation{ \mu L_z }
&=
\mu \Hbar
...
\begin{equation}\label{eqn:basicStatMechProblemSet5Problem3:580}
\begin{aligned}
