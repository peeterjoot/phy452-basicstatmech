...
%\section{Guts}
%
\makeoproblem{Energy and temperature}{pr:kittelCh2:1}{\citep{kittel1980thermal} pr. 2.1}{
...
%
We've got
\begin{equation}\label{eqn:kittelCh2:20}
\begin{aligned}
\inv{\tau}
&= \PD{U}{\sigma} \\
...
%
\imageFigure{../figures/phy452-basicstatmech/kittelCh2Fig1}{Plots of entropy and its derivatives for this multiplicity function.}{fig:kittelCh2:kittelCh2Fig1}{0.2}
%
The rate of change of entropy with energy decreases monotonically and is always positive, but always has a negative slope.
%
} % makeanswer
%
\makeoproblem{Paramagnetism}{pr:kittelCh2:2}{\citep{kittel1980thermal} pr. 2.2}{
...
\begin{equation}\label{eqn:kittelCh2:340}
\begin{aligned}
\inv{\tau}
&= \PD{U}{\sigma} \\
&= \PD{U}{} \left( \sigma_0 - \frac{U^2}{2 m^2 B^2 N} \right) \\
&= - \frac{U}{m^2 B^2 N}.
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:kittelCh2:380}
\begin{aligned}
\expectation{2 s} 
&= \frac{ \sqrt{ \frac{2}{\pi N}} 2^N \int_{-\infty}^\infty ds 2 s e^{-\frac{2s^2}{N}} } { 2^N } \\
&= 0.
\end{aligned}
\end{equation}
%
...
%
\makeoproblem{Quantum harmonic oscillator}{pr:kittelCh2:3}{\citep{kittel1980thermal} pr. 2.3}{
%
...
\begin{equation}\label{eqn:kittelCh2:120}
\begin{aligned}
\sigma
&= \ln g \\
&= \ln (N + n - 1)!  - \ln (N - 1)!  - \ln n! \\
&\approx (N + n - 1) \ln (N + n - 1) - (N + n - 1) - (N  - 1) \ln (N  - 1) + (N  - 1) - n \ln n + n \\
&= (N - 1) \ln \frac{N + n - 1}{N - 1} + n \ln \frac{N + n - 1}{n}.
\end{aligned}
\end{equation}
%
...
\begin{equation}\label{eqn:kittelCh2:140}
\begin{aligned}
\sigma
&\approx N \ln \frac{N + n}{N} + n \ln \frac{N + n}{n} \\
...
\begin{equation}\label{eqn:kittelCh2:160}
\begin{aligned}
\inv{\tau}
&= \PD{U}{\sigma} \\
