...
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig1}{Pairs of interacting spins.}{fig:lecture13:lecture13Fig1}{0.2}
%
\paragraph{Example: }
%
...
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig2}{Energy levels for two interacting spins as a function of magnetic field.}{fig:lecture13:lecture13Fig2}{0.2}
%
...
+ e^{ -\beta (J/4 + B)}.
\end{equation}
For \(N\) pairs our partition function is
...
\begin{equation}\label{eqn:basicStatMechLecture13:480}
\begin{aligned}
\CV
&= \PD{T}{\expectation{H}} \\
&= - \inv{T^2} \PD{\beta}{\expectation{H}} \\
&= -\beta^2 \PD{\beta}{} \lr{ -\frac{N}{Z_1} \PD{\beta}{Z_1} } \\
&= \beta^2 N \lr{ -\inv{Z_1^2} \lr{\PD{\beta}{Z_1}}^2 + \inv{Z_1} \PDSq{\beta}{Z_1} } \\
&= \frac{N \beta^2}{Z_1^2} \lr{ \PDSq{\beta}{Z_1} - \lr{\PD{\beta}{Z_1}}^2 }.
\end{aligned}
\end{equation}
%
...
\mu
&= \PD{B}{F} \\
&= \frac{T N}{Z_1} \lr{ \beta e^{-\beta(J/4 - B)} -\beta e^{-\beta(J/4 + B)} } \\
&= \frac{\cancel{T \beta} N}{Z_1} e^{-\beta J/4 } \lr{ e^{\beta B} -e^{-\beta B} } \\
...
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig3}{magnetic moment.}{fig:lecture13:lecture13Fig3}{0.2}
...
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig4}{Single particle spin energies as a function of magnetic field.}{fig:lecture13:lecture13Fig4}{0.2}
%
...
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig4a}{Single spin magnetization.}{fig:lecture13:lecture13Fig4a}{0.2}
%
...
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig5}{Interacting spin magnetization.}{fig:lecture13:lecture13Fig5}{0.2}
%
For the single particle specific heat we have specific heat of the form \cref{fig:lecture13:lecture13Fig6}.
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig6}{Single particle specific heat.}{fig:lecture13:lecture13Fig6}{0.2}
%
...
\end{equation}
%
\imageFigure{../figures/phy452-basicstatmech/lecture13Fig7}{Magnetization for interacting spins.}{fig:lecture13:lecture13Fig7}{0.2}
%
%\EndArticle
